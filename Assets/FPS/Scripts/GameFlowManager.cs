...
public class GameFlowManager : MonoBehaviour
{
    ...
    {
        //Telemetry
        TelemetryLogger.LogTotalPistolShots(pistolShotsFired);
        TelemetryLogger.LogTotalShotgunShots(shotgunShotsFired);
        TelemetryLogger.LogTotalDiscShots(discShotsFired);
        TelemetryLogger.LogTotalBurstShots(burstShotsFired);
        TelemetryLogger.LogRPresses(rpresses);
